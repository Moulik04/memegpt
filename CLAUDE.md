...
- [ ] **Multimodal Phase 3 (video)**: feasibility-gated on ffmpeg availability on Render's native runtime and async-capability — see `memegpt-multimodal-master-prompt.md`.
