...
export const EXAMPLE_PROMPTS_POOL: string[] = [
  ...
  // Sports
  "when your team is winning until the 4th quarter",
  "explaining the offside rule for the hundredth time",
  "when you jinx the game by saying it's basically won",
  "watching the game alone vs with the whole squad",
  "when the ref makes a call the entire stadium disagrees with",
  "my fantasy team's bench outscoring my starters",
  "when your team makes the playoffs after years of nothing",
  "screaming at the TV like the players can hear me",
  "when overtime happens and my heart can't take it",
  "explaining to non-fans why this rivalry game matters so much",
  "checking the score during a meeting when I really shouldn't be",
  "the walk of shame after betting on the wrong team",
  "when the team you gave up on comes back and wins anyway",

  // Movies & TV
  "when someone spoils the finale before I've watched it",
  "rewatching a show for the fifth time like it's the first",
  "when the trailer has all the good jokes already",
  "staying for the mid-credits scene alone in the theater",
  "explaining the plot of my favorite show to someone who's never seen it",
  "when the sequel doesn't live up to the original",
  "crying at a movie and pretending it's allergies",
  "when the popcorn runs out right as the movie starts",
  "binge-watching a whole season instead of sleeping",
  "arguing about which ending was better",
  "when the show gets cancelled on a cliffhanger",
  "waiting a year for season 2 and forgetting half the plot",

  // Music & concerts
  "waiting in line for merch longer than the concert itself",
  "when the opening act plays longer than the headliner",
  "screaming the lyrics even though I don't know all the words",
  "when the setlist skips the one song I came for",
  "losing my voice from singing too loud at a show",
  "when the aux cord gets passed to me and I freeze",
  "replaying the same song for the fortieth time this week",
  "when concert tickets sell out in 3 minutes flat",
  "explaining why this artist's old album is better",
  "the exact moment the beat drops at a live show",

  // Pop culture & internet
  "when a celebrity couple breaks up and the whole internet reacts",
  "explaining a meme to someone one week too late",
  "when the awards show runs three hours over",
  "arguing about who should've actually won",
  "when everyone's talking about a show I haven't started yet",
  "checking my phone every five minutes during a big announcement",
  "when the reboot doesn't match the original cast's energy",
  "the group chat exploding over one piece of celebrity news",
  "pretending I know who that is at a party",
  "when a trailer drops and breaks the internet for a day",

  // Shopping & brands
  "adding things to my cart and never checking out",
  "when the item's 'almost sold out' timer resets every time I refresh",
  "buying the store brand and pretending I can't tell the difference",
  "when the return window closes the day before I remember",
  "explaining why I own three unused gym bags from different brands",
  "when the same ad follows me around the internet for a week",
  "the specific joy of a package arriving early",
  "when the sale ends the day after I bought it full price",
  "comparing five tabs before buying the exact same thing anyway",
  "buying something just because the packaging looked nice",
