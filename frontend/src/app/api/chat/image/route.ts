...
// Multiple images (or an explicit meme_count) can generate several memes
// sequentially — see routers/chat.py's _stream_batch — plausibly 15-40s
// end-to-end, worse right after Render's ~30s free-tier cold start.
