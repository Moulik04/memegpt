...
USE_WHEN: dict[str, str] = {
    ...
    "turkish_shooter":          "EFFORTLESS PRO: Casually achieving with zero equipment, prep, or visible effort what everyone else needs full gear and sweat for — hand-in-pocket mastery. For minimal-effort excellence and 'built different' calm.",
    ...
    "sad_hamster":              "PATHETIC PLEADING EYES: Feeling small, rejected, or pitiful and milking it for sympathy — theatrical puppy-dog-eyes self-pity over something minor. For cute performative sadness.",
    ...
    "party_parrot":     "PURE HYPE CELEBRATION: A bobbing rainbow parrot losing its mind with excitement — unbridled, uncomplicated hype with zero nuance. E.g. the whole team losing it when the deploy finally goes green.",
